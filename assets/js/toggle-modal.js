...
function selectTheAlbum(dataName) {
  ...
  if (dataName === "suck-up") {
    iFrame.src =
      "https://bandcamp.com/EmbeddedPlayer/album=2646207013/size=large/bgcol=ffffff/linkcol=0687f5/tracklist=true/transparent=true/";
    iFrame.firstChild.href =
      "http://mattpignatore.bandcamp.com/album/suck-up-all-your-guts";
    ...
    iFrame.src =
      "https://bandcamp.com/EmbeddedPlayer/album=3186507886/size=large/bgcol=ffffff/linkcol=0687f5/tracklist=true/transparent=true/";
    iFrame.firstChild.href =
      "http://mattpignatore.bandcamp.com/album/demos-2016";
    ...
    iFrame.src =
      "https://bandcamp.com/EmbeddedPlayer/album=1512032327/size=large/bgcol=ffffff/linkcol=0687f5/tracklist=true/transparent=true/";
    iFrame.firstChild.href =
      "http://mattpignatore.bandcamp.com/album/go-get-hurt";
    ...
    iFrame.src =
      "https://bandcamp.com/EmbeddedPlayer/album=2636136889/size=large/bgcol=ffffff/linkcol=0687f5/tracklist=true/transparent=true/";
    iFrame.firstChild.href =
      "http://mattpignatore.bandcamp.com/album/i-thought-i-would-start-to-feel-more-whole-at-any-moment";
    iFrame.firstChild.innerText = "At Any Moment by Matt Pignatore";
    iFrame.dataset.name = "at-any-moment";

    // Good Time
  } else if (dataName === "good-time") {
    iFrame.src =
      "https://bandcamp.com/EmbeddedPlayer/album=1553673192/size=large/bgcol=ffffff/linkcol=0687f5/tracklist=true/transparent=true/";
    iFrame.firstChild.href =
      "http://mattpignatore.bandcamp.com/album/good-time";
    iFrame.firstChild.innerText = "Good Time by Matt Pignatore";
    iFrame.dataset.name = "good-time";
  }
}
